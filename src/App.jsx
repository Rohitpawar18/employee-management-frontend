  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f0f4f8", fontFamily: "'Segoe UI', sans-serif" }}>
      ...
      <div style={{ background: "#1a1a2e", padding: "14px 32px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <span style={{ background: "#4f8ef7", color: "white", fontSize: "12px", padding: "4px 14px", borderRadius: "20px" }}>System</span>
      </div>
      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "24px 20px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "14px", marginBottom: "24px" }}>
          ...
          <div
            onClick={exportToCSV}
            style={{ background: "white", borderRadius: "10px", padding: "18px 20px", borderLeft: "4px solid #8b5cf6", cursor: "pointer" }}
          >
                ...
                {filtered.map((emp, i) => (
                  <tr key={emp.id} style={{ borderTop: "1px solid #f0f4f8", background: i % 2 === 0 ? "white" : "#fafafa" }}>
                    ...
                    <td style={{ padding: "13px 16px" }}>
                      <span style={{ background: "#eff6ff", color: "#3b82f6", padding: "3px 12px", borderRadius: "20px", fontSize: "12px", fontWeight: "500" }}>
                        {emp.department}
                      </span>
                    </td>
                    <td style={{ padding: "13px 16px", color: "#1a1a2e", fontWeight: "500" }}>₹{emp.salary.toLocaleString()}</td>
                    <td style={{ padding: "13px 16px" }}>
                      <button onClick={() => handleEdit(emp)} style={{ background: "#fef3c7", color: "#d97706", border: "none", padding: "5px 14px", borderRadius: "6px", cursor: "pointer", fontSize: "12px", fontWeight: "500", marginRight: "6px" }}>
                        Edit
                      </button>
                      <button onClick={() => handleDelete(emp.id)} style={{ background: "#fee2e2", color: "#ef4444", border: "none", padding: "5px 14px", borderRadius: "6px", cursor: "pointer", fontSize: "12px", fontWeight: "500" }}>
                        Delete
                      </button>
                    </td>
                  </tr>
